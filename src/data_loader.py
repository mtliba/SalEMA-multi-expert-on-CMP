...
# The DataLoader for Poles
class Poles(data.Dataset):
  ...
  def __init__(self, split, clip_length, number_of_videos, starting_video, root_path, load_gt, resolution=None, val_perc = 0.01):
        ...
        # A list to keep all video , which will be our dataset.
        self.video_list = []

        # A list to keep all the dictionaries of frames - saliency map pairings for each video
        self.gts_list = []
